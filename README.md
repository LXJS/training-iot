...
* 5: [Nitrogen Overview](http://nitrogen.io/docs/concepts/overview.html): An overview of the Nitrogen platform and how all of the pieces of it fit together.

### Prep work

* 1: Register for a [Nitrogen account](http://admin.nitrogen.io).
* 2: [Download your personalized Raspbian image](http://admin.nitrogen.io/#/images) from the Nitrogen site.
* 3: Work through the [laptop camera guide](http://nitrogen.io/guides/start/setup.html).
